<!-- Main Header -->
            <header class="main-header">
                ...
                <a href="dashboard.php" class="logo">
                    ...
                    <span class="logo-mini"><img src="img/marca_system.png" width="50" /></span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><img src="img/logo_system.png" width="125" /></span>
                </a>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <img src="system/dist/img/user.jpg" class="user-image" alt="User Image">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        <img src="system/dist/img/user.jpg" class="img-circle" alt="User Image">
                                        <p>
                                            Mayco Vilefort<br>
                                            Diretor
