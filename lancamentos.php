        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a id="Lancamentos" class="btn btn-app j_Add"><i class="fa fa-edit"></i> Cadastrar</a>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-info btn-flat j_datapicker_lancamentos" type="button">Filtrar</button>
